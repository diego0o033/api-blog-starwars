...
class User(db.Model):
    ...
    def __repr__(self):
        # si pongo la coma en el repr, interpreta que debe acceder a una tupla y no esta admitido, ya que accede a un diccio
...
class Character(db.Model):
    ...
    id_starship = db.Column(db.Integer,nullable=False)
...
class People(db.Model):
    ...
    force_side = db.Column(db.String(20), nullable=False)
    type_warrior = db.Column(db.Integer, nullable=False)
    parents = db.Column(db.Boolean(), nullable=False)
...
class Starship(db.Model):
    ...
    url_starship = db.Column(db.Integer,nullable=False)
    description_starship = db.Column(db.String(1000), nullable=False)
